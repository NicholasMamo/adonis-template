...
\begin{document}
	...
	\section{Layout}
		...
		Unlike the \textit{article} template, \textit{Adonis} includes a header and a footer.
		The header shows the running author on the left and the running title on the right.
		...
		\subsection{Front-matter}
			...
			The rest of the front-matter details, including the affiliations, the date of publication and the correspondence, appear at the bottom of the page in small type.\footnote{
				...
				In other words, you need to link the author with the affiliations manually, such as by adding superscript numbers next to your author and next to the affiliations.
			}
			...
			\begin{verbatim}
				\affiliation{\textsuperscript{1} Affiliation}
