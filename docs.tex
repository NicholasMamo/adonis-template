...
\begin{document}
	...
	\section{Typography}
		...
		Finally, \textit{Adonis} uses the semi-bold font-weight in place of the bold-weight when using \texttt{\textbf}.
		The actual bold font-weight looks heavy enough to feel jarring next to the regular font-weight.
